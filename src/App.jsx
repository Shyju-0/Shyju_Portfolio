  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white overflow-x-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="flex flex-col lg:flex-row items-center justify-center gap-12">
            ...
            <div className="text-center lg:text-left animate-fadeInRight">
              ...
              <h2 className="text-2xl md:text-3xl text-gray-300 mb-8 animate-typewriter">
                Full-Stack Developer
              </h2>
              <p className="text-xl text-gray-400 max-w-3xl mb-12 leading-relaxed animate-fadeInUp delay-300">
                Passionate about building scalable, real-time, and secure web
                applications using modern technologies. Specialized in Next.js,
                React.js, Node.js, TypeScript, and cloud-native development
                practices.
              </p>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <p className="text-gray-300 text-lg leading-relaxed mb-6">
                I'm a skilled full-stack developer with hands-on experience in
                building scalable, real-time, and secure web applications. My
                passion lies in learning, problem-solving, and contributing to
                impactful solutions in collaborative team environments.
              </p>
              <p className="text-gray-300 text-lg leading-relaxed mb-6">
                I'm familiar with integrating hardware and software systems and
                exploring cloud-native development practices. I'm eager to grow
                in fast-paced engineering teams with exposure to full-stack
            ...
            <div className="grid grid-cols-2 gap-6">
              ...
              <div className="bg-white/5 backdrop-blur-sm rounded-lg p-6 border border-white/10">
                ...
                <p className="text-gray-400">
                  Dedicated with full interest in every project
                </p>
              </div>
              <div className="bg-white/5 backdrop-blur-sm rounded-lg p-6 border border-white/10">
                <h3 className="text-xl font-semibold mb-2 text-cyan-400">
      ...
      <section id="skills" className="py-20">
        <div className="container mx-auto px-6">
          <h2
            className={`text-4xl font-bold text-center mb-16 bg-gradient-to-r from-cyan-400 to-purple-400 bg-clip-text text-transparent transition-all duration-1000 ${
              ...
              >
                <div className="flex items-center mb-4">
                  {category.includes("Frontend") && (
                    <Globe
                      className="text-cyan-400 mr-3 group-hover:animate-spin transition-transform duration-300"
                      size={24}
                    />
                  )}
                  {category.includes("Backend") && (
                    <Server
                      className="text-purple-400 mr-3 group-hover:animate-pulse transition-transform duration-300"
                      size={24}
                    />
                  )}
                  {category.includes("Database") && (
                    <Database
                      className="text-pink-400 mr-3 group-hover:animate-bounce transition-transform duration-300"
                      size={24}
                    />
                  )}
                  {category.includes("Languages") && (
                    <Code
                      className="text-cyan-400 mr-3 group-hover:animate-pulse transition-transform duration-300"
                      size={24}
                    />
                  )}
                  {category.includes("Tools") && (
                    <Globe
                      className="text-purple-400 mr-3 group-hover:animate-spin transition-transform duration-300"
                      size={24}
                    />
                  )}
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="space-y-8">
            {experiences.map((exp, index) => (
              <div
                key={index}
                className="bg-white/5 backdrop-blur-sm rounded-lg p-8 border border-white/10 hover:border-cyan-400/50 transition-all duration-300"
              >
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            {projects.map((project, index) => (
              <div
                key={index}
                className="bg-white/5 backdrop-blur-sm rounded-lg p-6 border border-white/10 hover:border-cyan-400/50 transition-all duration-300 transform hover:scale-105"
              >
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  {project.tech.map((tech, techIndex) => (
                    <span
                      key={techIndex}
                      className="bg-purple-500/20 px-2 py-1 rounded text-sm border border-purple-400/30"
                    >
                      {tech}
                    </span>
                  ))}
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-4 gap-8">
              ...
              <div className="bg-white/5 backdrop-blur-sm rounded-lg p-6 border border-white/10 text-center hover:border-pink-400/50 transition-all duration-300">
                ...
                <a
                  href="https://www.linkedin.com/in/shyju-s-08a891278/"
                  target="_blank"
              ...
              <div className="bg-white/5 backdrop-blur-sm rounded-lg p-6 border border-white/10 text-center hover:border-green-400/50 transition-all duration-300">
                <Github className="text-green-400 mx-auto mb-4" size={32} />
                <h3 className="text-xl font-semibold mb-2">GitHub</h3>
                <a
                  href="https://github.com/Shyju-0"
                  target="_blank"
                  rel="noopener noreferrer"
      ...
      <footer className="py-8 border-t border-white/10">
        ...
        <div className="container mx-auto px-6 flex flex-col md:flex-row items-center justify-between text-sm text-gray-400">
          <p>© {new Date().getFullYear()} Shyju S. All rights reserved.</p>
